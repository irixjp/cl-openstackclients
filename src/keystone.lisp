...
(defclass keystone-v2 ()
  ((api-version  :initform "v2.0" :initarg :api-version  :accessor get-api-version)
   ...
   (tenantname   :initform nil    :initarg :tenantname   :accessor get-tenantname)
   (username     :initform nil    :initarg :username     :accessor get-username)
   (role         :initform nil    :initarg :role         :accessor get-role)
   (password     :initform nil    :initarg :password     :accessor get-password)
   (token-id     :initform nil    :initarg :token-id     :accessor get-token-id)
   (token-expire :initform nil    :initarg :token-expire :accessor get-token-expire)
   (tenant-id    :initform nil    :initarg :tenantid     :accessor get-tenant-id)
   (endpoints    :initform nil    :initarg :endpoints    :accessor get-endpoints)))
...
@export
(defgeneric ks_retrieve_endpoints (keystone)
  (:documentation ""))

@export
(defgeneric ks_retrieve_token_id (keystone)
  (:documentation ""))

@export
(defgeneric ks_retrieve_token_expire (keystone)
  (:documentation ""))

@export
(defgeneric ks_retrieve_tenantname (keystone)
  (:documentation ""))

@export
(defgeneric ks_retrieve_rolename (keystone)
  (:documentation ""))

@export
(defgeneric ks_retrieve_username (keystone)
  (:documentation ""))

@export
(defgeneric ks_adminp (keystone)
  (:documentation ""))

@export
(defgeneric ks_list_users (keystone)
  (:documentation ""))

@export
(defgeneric ks_list_tenants (keystone)
  (:documentation ""))

@export
(defgeneric ks_list_roles (keystone)
  (:documentation ""))
